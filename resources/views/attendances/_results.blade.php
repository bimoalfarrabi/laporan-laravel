                                ...
                                <div x-data="{ imageLoaded: false }"
                                    ...
                                    <a class="open-photo-modal cursor-pointer"
                                        ...
                                        <img src="{{ route('files.serve', ['path' => $attendance->photo_in_path, 'size' => '50x50']) }}"
                                            ...
                                            @@error="imageLoaded = true; $el.src = 'data:image/svg+xml;base64,'"
