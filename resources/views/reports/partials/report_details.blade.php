                ...
                <div>
                    ...
                    <div class="mt-2 text-base text-gray-900 dark:text-gray-100">
                        ...
                        @elseif ($field->type === 'file')
                            ...
                            @elseif(isset($report->data['_media_status'][$field->name]) && $report->data['_media_status'][$field->name] === 'deleted')
                                <div
                                    class="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 mt-2 rounded-r-lg">
                                    <div class="flex">
                                        <div class="flex-shrink-0">
                                            <svg class="h-5 w-5 text-yellow-500" viewBox="0 0 20 20"
                                                fill="currentColor">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-yellow-700 dark:text-yellow-200">
                                                Media telah dihapus untuk menghemat penyimpanan.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @elseif(isset($report->data['_media_status'][$field->name]) && $report->data['_media_status'][$field->name] === 'deleted')
                                <div
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm text-yellow-700 dark:text-yellow-200">
                                                Video telah dihapus untuk menghemat penyimpanan.
                                            </p>
                                        </div>
                                    </div>
                                </div>
