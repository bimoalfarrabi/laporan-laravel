        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div
                        class="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">Pilih Bulan dan Tahun
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">Pilih bulan dan tahun untuk
                            men-download laporan bulanan
                            dalam format PDF.</p>
                        <form
                            action="{{ route('reports.exportMonthlyPdf', ['year' => 'YEAR_PLACEHOLDER', 'month' => 'MONTH_PLACEHOLDER']) }}"
