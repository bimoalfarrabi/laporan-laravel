        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Pilih Jenis Laporan yang Ingin
                        Dibuat:</h3>
                    ...
                    @else
                        <div class="mb-4">
                            <input type="text" id="report-type-search" placeholder="Cari jenis laporan..."
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" id="report-type-grid">
                            @foreach ($reportTypes as $type)
                                ...
                                <a href="{{ route('reports.create', ['report_type_id' => $type->id]) }}"
                                    class="report-type-card block p-6 bg-gray-100 dark:bg-gray-700 rounded-lg shadow hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-150 ease-in-out">
                        ...
                        <div id="no-results-message" class="hidden text-center py-10">
                            <p class="text-gray-500 dark:text-gray-400">Tidak ada jenis laporan yang cocok dengan
                                pencarian Anda.</p>
                        </div>
                    @endif
