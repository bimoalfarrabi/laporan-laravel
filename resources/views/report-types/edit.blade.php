                    ...
                    <form method="POST" action="{{ route('report-types.update', $reportType->id) }}">
                        ...
                        <div class="mt-4 mb-4">
                            ...
                            <textarea id="description" name="description"
                                class="block mt-1 w-full border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('description', $reportType->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="is_active" name="is_active"
                                ...
                                <option value="0"
                                    {{ old('is_active', $reportType->is_active) == '0' ? 'selected' : '' }}>Tidak Aktif
                                </option>
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <x-text-input id="retention_days_images" class="block mt-1 w-full" type="number"
                                    name="retention_days_images" :value="old('retention_days_images', $reportType->retention_days_images)" min="1"
                            ...
                            <div>
                                ...
                                <x-text-input id="retention_days_videos" class="block mt-1 w-full" type="number"
                                    name="retention_days_videos" :value="old('retention_days_videos', $reportType->retention_days_videos)" min="1"
                                    placeholder="Kosongkan untuk simpan selamanya" />
