<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Arsip Laporan Harian Jaga (Dihapus)') }}
        </h2>
    </x-slot>
                                    ...
                                    @foreach ($laporan as $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                @can('restore', $item)
                                                    <form action="{{ route('laporan-harian-jaga.restore', $item->id) }}"
                                                ...
                                                @can('forceDelete', $item)
                                                    <form
                                                        action="{{ route('laporan-harian-jaga.forceDelete', $item->id) }}"
                                                        method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
