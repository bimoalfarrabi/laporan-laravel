                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="center_latitude" class="block mt-1 w-full" type="text"
                                        name="center_latitude" :value="old('center_latitude', $settings['center_latitude'] ?? '')" required />
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="center_longitude" class="block mt-1 w-full" type="text"
                                        name="center_longitude" :value="old('center_longitude', $settings['center_longitude'] ?? '')" required />
                                ...
                                <div class="mb-4">
                                    ...
                                    <x-text-input id="allowed_radius_meters" class="block mt-1 w-full" type="number"
                                        name="allowed_radius_meters" :value="old(
                                            'allowed_radius_meters',
                                            $settings['allowed_radius_meters'] ?? '100',
                                        )" required />
                            ...
                            <div>
                                ...
                                <div id="map" style="height: 400px;"
                                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600"></div>
                                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Klik pada peta untuk mengatur
                                    Latitude &
                                    Longitude.</p>
                            </div>
                        </div>
